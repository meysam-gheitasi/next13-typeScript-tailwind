  ...
  return (
    <nav className='flex-center  w-full fixed z-50 top-0 border border-b-2 border-black-200 text-white'>
      <div className='flex-between mx-auto w-full  max-w-screen-2xl px-6 py-3 md:px-8 sm:px-16'>
        <div className='flex-center pb-4 px-2 gap-x-2'>
          <Link href='/'>
          ...
          <span className='block max-md:hidden body-text text-gradient_blue-purple !font-semibold'>
        ...
        <div className=" w-64 max-md:w-96 relative hover:cursor-pointer">
          <input className="w-full py-3 px-2 mt-2 hover:cursor-pointer placeholder:text-sm rounded-md bg-black-200 border-none outline-none  placeholder-gray-500 italic mb-4" type="text" placeholder="جستجو فیلم ؟" />
